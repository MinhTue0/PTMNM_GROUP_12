			...
			<div id="content">
				...
				<div class="container-fluid">
					<div class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Health Satus</h1>
					</div>
					<form action="submit_health_new.php" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Thể trạng:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Lượng nước:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Cơ bắp:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Xương:</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							<label for="field-1" class="col-sm-3 control-label">Nhận xét:</label>
							<div class="col-sm-5">
