				...
				<div class="container-fluid">
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							...
							<?php echo $_POST['from']; ?> Đến : <?php echo $_POST['to']; ?>
							...
							<h4>Tổng thanh toán trong tháng :<?php echo $sno - 1; ?></h4>
							<h4>Tổng thu nhập trong tháng này :<?php echo $total; ?></h4>
						</div>
					</div>
				</div>
