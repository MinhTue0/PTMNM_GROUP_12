					...
					<div class="card shadow mb-4">
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered" id="dataTable" style="width:100%; height: 100%; overflow: hidden" cellspacing="0">
									<thead>
										<tr>
														...
														echo "
															<td>
																<form action='read_member.php' method='post'>
																	...
																	<input type='submit' value='Xem lịch sử' class='btn btn-info'/>
																</form>
																<form action='edit_member.php' method='post'>
																	<input type='hidden' name='name' value='" . $msgid . "'/>
																	<input type='submit' value='Sửa thông tin' class='btn btn-warning'/>
