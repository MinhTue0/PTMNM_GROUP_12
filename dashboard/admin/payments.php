							...
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable"  cellspacing="0">
									<thead>
										<tr>
											<th>Ngày ĐK</th>
											<th>Tên / ID Thành viên</th>
											<th>Địa chỉ / Liên hệ</th>
											<th>Giấy tờ</th>
											<th>E-Mail / Tuổi / GTính</th>
											<th>C.Cao / C.Nặng</th>
											<th>Ngày sinh / Gói tập</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody>
											...
											while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
												...
												if (mysqli_affected_rows($con) == 1) {
													while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
														...
														echo "<td><form action='make_payments.php' method='post'><input type='hidden' name='name' value='" . $msgid . "'/><input type='submit' value='Thanh toán' class='btn btn-info'/></form></td></tr>";
														$msgid = 0;
													}
												}
											}
